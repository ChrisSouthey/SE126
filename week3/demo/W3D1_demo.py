...
#len() --> LENGTH FUNCTION; when passed a (list) it returns an intager: # of values in list
...
for index in range(0, len(hdd_1_list)):
    ...
    count_size += 1
average = total_size / count_size #could also use: 'len(hdd_1_list)' in place of 'count_size'

print(f"AVERAGE HDD#1 SIZE: {average:.2f}TB or {average*1000:.2f}GB")
